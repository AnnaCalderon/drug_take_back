...
```{r}
# these don't have a standars address structure 
...
# all addresses with right location -- missing the wrong addresses 
# the ones that will be located using zip-code 
all_good_data <- rbind(good_data_clean, wrong_address_ok)
